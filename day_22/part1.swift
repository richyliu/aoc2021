...
// part 1: remove all cuboids outside of -50, 50 range for x, y, and z
let removeOutside = [
  Action(isOn: false, region: Cuboid(x: IntRange(start: 50, end: Int.max), y: IntRange(start: Int.min, end: Int.max), z: IntRange(start: Int.min, end: Int.max))),
  Action(isOn: false, region: Cuboid(x: IntRange(start: Int.min, end: -50), y: IntRange(start: Int.min, end: Int.max), z: IntRange(start: Int.min, end: Int.max))),
  Action(isOn: false, region: Cuboid(x: IntRange(start: -50, end: 50), y: IntRange(start: 50, end: Int.max), z: IntRange(start: Int.min, end: Int.max))),
  Action(isOn: false, region: Cuboid(x: IntRange(start: -50, end: 50), y: IntRange(start: Int.min, end: -50), z: IntRange(start: Int.min, end: Int.max))),
  Action(isOn: false, region: Cuboid(x: IntRange(start: -50, end: 50), y: IntRange(start: -50, end: 50), z: IntRange(start: 50, end: Int.max))),
  Action(isOn: false, region: Cuboid(x: IntRange(start: -50, end: 50), y: IntRange(start: -50, end: 50), z: IntRange(start: Int.min, end: -50))),
]

for action in removeOutside {
    cuboids = action.apply(to: cuboids)
    print("\(cuboids.count) cuboids")
}
